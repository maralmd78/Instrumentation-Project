...
const char *ssid =  "Bhn7-bWFyYWw";     // replace with your wifi ssid and wpa2 key
const char *pass =  "maral1234";

String thingsboard = "http://192.168.43.12:8080";
String token = "ECG_MONITOR_TOKEN";
WiFiClient client;
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    http.begin(client, thingsboard + "/api/v1/" + token + "/telemetry");
